...
class AuthViewModel: ObservableObject {
    ...
    func createUser(withEmail email: String, password: String, fullName: String, bio: String, eduactionLevel: eduactionLevelEnums, skills: [String], experienceLevel: experienceLevelEnums, careerGoal: String, interests: String, skillGap: [String]) async throws {
        
        print("DEBUG: \(fullName) and \(email) and \(password) and bio \(bio) and eduaction Level is \(eduactionLevel) and skills \(skills) and experience Level \(experienceLevel) and career Goal \(careerGoal) and interests \(interests) and skill Gap\(skillGap) are saved")
        do {
